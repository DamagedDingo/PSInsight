...
FunctionsToExport = 'Get-InsightObjectSchema', 'New-InsightObjectSchema', 
               ...
               'Build-ObjectType', 'Build-Schema', 'Connect-MEMCM', 
               'Convert-ChassisType', 'Get-MEMCMSQL_ExtendedInfo', 
               'Get-ZoomRoomsObjects', 'Test-Module', 'Find-InsightObjects', 
